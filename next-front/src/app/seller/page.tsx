...
import { Plus, Pencil, Trash2, Store, PackageOpen, Loader2, Calendar, Package, AlertTriangle } from 'lucide-react';
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-xl p-6 w-full max-w-sm">
        <div className="flex flex-col items-center text-center">
          ...
          <h2 className="text-lg font-bold text-gray-800 mb-1">Delete product?</h2>
        ...
        <div className="flex gap-3 mt-6">
          ...
          <button onClick={onConfirm} disabled={loading}
            className="flex-1 bg-red-500 text-white py-2.5 rounded-lg text-sm font-medium hover:bg-red-600 transition-colors disabled:opacity-60 flex items-center justify-center gap-2">
        ...
        {store && (
          <div className="bg-white rounded-xl shadow-sm p-5 flex flex-col sm:flex-row items-start sm:items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-500 text-sm mt-0.5 line-clamp-2">{store.description}</p>
                  ...
                  <div className="p-3">
                    ...
                    <div className="flex gap-2 mt-2">
                      <button onClick={() => router.push(`/seller/products/${product.id}/edit`)}
                        className="flex-1 flex items-center justify-center gap-1.5 border border-gray-300 text-gray-600 py-2 rounded-lg text-xs font-medium hover:bg-gray-50 transition-colors">
                        <Pencil size={13} /> Edit
                      </button>
                      <button onClick={() => setConfirmProduct(product)} disabled={deleting === product.id}
                        className="flex items-center justify-center gap-1 border border-red-200 text-red-500 px-3.5 py-2 rounded-lg text-xs hover:bg-red-50 transition-colors disabled:opacity-50">
